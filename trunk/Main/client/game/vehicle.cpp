...
void CVehicle::DoubleSpeed(void)
{
	VECTOR vecMoveSpeed;
	GetMoveSpeedVector(&vecMoveSpeed);
	vecMoveSpeed.X = vecMoveSpeed.X * 2;
	vecMoveSpeed.Y = vecMoveSpeed.Y * 2;
	vecMoveSpeed.Z = vecMoveSpeed.Z * 2;
	SetMoveSpeedVector(vecMoveSpeed);
	GetTurnSpeedVector(&vecMoveSpeed);
	vecMoveSpeed.X = vecMoveSpeed.X * 2;
	vecMoveSpeed.Y = vecMoveSpeed.Y * 2;
	vecMoveSpeed.Z = vecMoveSpeed.Z * 2;
	SetTurnSpeedVector(vecMoveSpeed);
}

void CVehicle::VehicleJump(float ForwardDistance, float UpDistance)
{
	VECTOR vecMoveSpeed;
	GetMoveSpeedVector(&vecMoveSpeed);
	float rotZ = 0;
	ScriptCommand(&get_car_z_angle,m_dwGTAId,&rotZ);
	rotZ += 90;
	float X = (float)cos(rotZ/180*PI)*ForwardDistance;
	float Y = (float)sin(rotZ/180*PI)*ForwardDistance;
	vecMoveSpeed.X = vecMoveSpeed.X + X;
	vecMoveSpeed.Y = vecMoveSpeed.Y + Y;
	vecMoveSpeed.Z = vecMoveSpeed.Z + UpDistance;
	SetMoveSpeedVector(vecMoveSpeed);
}
